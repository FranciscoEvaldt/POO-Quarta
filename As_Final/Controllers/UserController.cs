...
namespace As
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public UserController(IUserService usuarioService, IBookService livroService, IMapper mapper)
        {
        ...
        public IActionResult GetAllUsuarios()
        {
            ...
            var usuarioDTOs = _mapper.Map<List<UserDTO>>(usuarios);
        ...
        [HttpPost]
        public IActionResult CreateUsuario([FromBody] UserDTO usuarioDTO)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult UpdateUsuario(int id, [FromBody] UserDTO usuarioDTO)
        {
            var usuario = _mapper.Map<User>(usuarioDTO);
            usuario.Id = id;
